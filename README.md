...
**Simple Banking OTP Application.**

OTP Application developed for fulfillment of the requirements exposed in the job test describe below.

## Run Tests

You can run included tests with `mix test`
...
* [Erlang Version Manager (Kerl)](https://github.com/kerl/kerl)

* [Elixir Version Manager (Kiex)](https://github.com/taylor/kiex)
